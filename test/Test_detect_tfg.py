...
from visualization_utils import plot_tree_locations, display_slice_with_centroids, display_original_cloud_with_centroids
...
def test_detection():
    ...
    for file in files:
        ...
        total_accuracyT, TPT, FPT, FNT, treeNumT, f1_scoreT, precisionT, recallT = check_accuracy(detection2, fileN)
